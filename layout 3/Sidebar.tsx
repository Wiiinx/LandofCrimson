...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, setViewingPost, setView }) => {
  const menuItems = [
    { id: 'dashboard', icon: User, label: 'CORE', sub: 'IDENTITY' },
    { id: 'exploration', icon: Compass, label: 'EXPLORE', sub: 'ZONE_SCAN' },
    { id: 'map', icon: MapIcon, label: 'MAP', sub: 'NAVIGATION' },
    { id: 'missions', icon: Briefcase, label: 'STORY', sub: 'CONTRACTS' },
    { id: 'social', icon: Users, label: 'LINK', sub: 'NETWORK' },
    { id: 'forum', icon: MessageSquare, label: 'NET', sub: 'FORUMS' },
    { id: 'market', icon: ShoppingCart, label: 'SHOP', sub: 'BLACK_MKT' },
    { id: 'terminal', icon: TerminalIcon, label: 'CMD', sub: 'SYSTEM_LOG' },
  ];
